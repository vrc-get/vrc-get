...
export type TauriProject = { name: string; path: string; project_type: TauriProjectType; unity: string; unity_revision: string | null; last_modified: number; created_at: number; display_name: string | null; favorite: boolean; is_exists: boolean; is_valid: boolean | null }
...
export type TauriProjectDetails = { unity: [number, number]; unity_str: string; unity_revision: string | null; installed_packages: ([string, TauriBasePackageInfo])[]; should_resolve: boolean; display_name: string | null }
...
export type TauriUpdatedRealProjectInfo = { path: string; is_valid: boolean; project_type: TauriProjectType; unity: string; unity_revision: string | null; display_name: string | null }
