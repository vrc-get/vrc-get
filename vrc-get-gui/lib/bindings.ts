...
export function environmentImportRepositoryPick() {
	return invoke()<TauriImportRepositoryPickResult>(
		"environment_import_repository_pick",
	);
}

export function environmentImportDownloadRepositories(
	channel: string,
	...
	return invoke()<
		AsyncCallResult<
			number,
			[TauriRepositoryDescriptor, TauriDownloadRepository][]
		>
	>("environment_import_download_repositories", { channel, repositories });
}

export function environmentImportAddRepositories(
	repositories: TauriRepositoryDescriptor[],
) {
	return invoke()<null>("environment_import_add_repositories", {
		repositories,
	});
}
...
export function environmentAddUserPackageWithPicker() {
	return invoke()<TauriAddUserPackageWithPickerResult>(
		"environment_add_user_package_with_picker",
	);
}
...
export function environmentSetUseAlcomForVccProtocol(
	useAlcomForVccProtocol: boolean,
) {
	return invoke()<null>("environment_set_use_alcom_for_vcc_protocol", {
...
export function projectGetCustomUnityArgs(projectPath: string) {
	return invoke()<string[] | null>("project_get_custom_unity_args", {
		projectPath,
	});
}

export function projectSetCustomUnityArgs(
	projectPath: string,
	args: string[] | null,
) {
	return invoke()<boolean>("project_set_custom_unity_args", {
		projectPath,
		args,
	});
}
...
export function projectSetUnityPath(
	projectPath: string,
	unityPath: string | null,
) {
	return invoke()<boolean>("project_set_unity_path", {
		projectPath,
		unityPath,
	});
}
...
export type TauriAddUserPackageWithPickerResult =
	| "NoFolderSelected"
	| "InvalidSelection"
	| "AlreadyAdded"
	| "Successful";
...
export type TauriImportRepositoryPickResult =
	| { type: "NoFilePicked" }
	| {
